...
![pinoutRust](img/rust_board_v1_pin-layout.png)
...
![schematicRust](img/esp-rust-board.png)
...
!!! danger "Tareas"
    ...
    * [Opcional] Importa el componente **ICM42607/ICM42670 6-Axis MotionTracking (Accelerometer and Gyroscope)** del [Registro de Componentes](https://components.espressif.com/components/espressif/icm42670/versions/1.0.0). Utiliza el acelerómetro para determinar la orientación de la placa (boca arriba, boca abajo, en vertical, horizontal...). Puedes actuar sobre el LED conectado a GPIO 7 en función de la orientación.