...
ejemplo de modelo genérico ON-OFF (bluetooth/esp_ble_mesh/ble_mesh_node), en el
que se simulará una red domótica con un interruptor y varias luces conectadas a
